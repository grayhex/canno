...
def html(body):
    return (
        ...
        "<a id='nav-home' class='top-nav-btn top-nav-link btn btn-outline' href='/'><span class='nav-ico' aria-hidden='true'>⌂</span>Домой</a>"
        "<a class='top-nav-btn top-nav-link btn btn-outline' href='/admin/login'><span class='nav-ico' aria-hidden='true'>🛡</span>Админ</a>"
        "<a class='top-nav-btn top-nav-link btn btn-outline' href='/editor/login'><span class='nav-ico' aria-hidden='true'>✎</span>Редактор</a>"
        "</nav>"
        "<button id='nav-menu-toggle' class='top-nav-btn top-nav-menu-toggle btn btn-outline' type='button' aria-expanded='false' aria-controls='nav-mobile-panel'>☰ Меню</button>"
        "<nav id='nav-mobile-panel' class='top-nav-mobile-panel' aria-label='Мобильное меню' aria-hidden='true'>"
        "<button id='nav-mobile-back' class='top-nav-btn btn btn-outline' type='button'><span class='nav-ico' aria-hidden='true'>←</span>Назад</button>"
        "<a class='top-nav-btn top-nav-link btn btn-outline' href='/'><span class='nav-ico' aria-hidden='true'>⌂</span>Домой</a>"
        "<a class='top-nav-btn top-nav-link btn btn-outline' href='/admin/login'><span class='nav-ico' aria-hidden='true'>🛡</span>Админ</a>"
        "<a class='top-nav-btn top-nav-link btn btn-outline' href='/editor/login'><span class='nav-ico' aria-hidden='true'>✎</span>Редактор</a>"
        "</nav>"
        "</header>"
