...
def html(body):
    return (
        ...
        "<a class='top-nav-btn top-nav-link btn btn-outline top-nav-icon-btn' href='/admin/login' title='Админ' aria-label='Админ'><span class='nav-ico' aria-hidden='true'>🛡</span><span class='sr-only'>Админ</span></a>"
        "<a class='top-nav-btn top-nav-link btn btn-outline top-nav-icon-btn' href='/editor/login' title='Редактор' aria-label='Редактор'><span class='nav-ico' aria-hidden='true'>✎</span><span class='sr-only'>Редактор</span></a>"
        "</nav>"
        "</header>"
